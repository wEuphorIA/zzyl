...
public class GenUtils
{
    ...
    public static void initColumnField(GenTableColumn column, GenTable table)
    {
        ...
        else if (arraysContains(GenConstants.COLUMNTYPE_NUMBER, dataType))
        {
            ...
            // 如果是整形
            else if (str != null && str.length == 1 && Integer.parseInt(str[0]) <= 10 || GenConstants.MYSQL_TINYINT.equals(column.getColumnType()) || GenConstants.MYSQL_INT.equals(column.getColumnType()))
            {
